...
// #A0A694
    return(
        <section className="m-auto flex flex-col md:flex-row lg:flex-row h-[100vh] w-[98vw] ">
            <div id="postsSection" className="overflow-y-scroll m-auto py-[15px] w-[100%] md:h-[95%] lg:h-[95%] h-[90%] bg-[#CCCFC0] rounded-lg ">
            </div>
            ...
            <div className="w-[100%] md:w-[40%] lg:w-[40%] h-[5vh] absolute  md:relative lg:relative xl:relative m-auto ">
                <p className="text-center text-white mt-[5px] ">Shamiya's Film Reviews</p>
            </div>
        </section>
    )
